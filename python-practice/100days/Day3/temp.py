...
while True:
    try:
        order_size = input("What pizza size would you like?(S,M or L) ").capitalize()
...
while True:
    try:
        add_cheese = input("Would you like to add some cheese? (Yes or No)").capitalize()
...
while True:
    try:
        add_pepperoni = input("Would you like pepperoni. (Yes or No)") .capitalize()
